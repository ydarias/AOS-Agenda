...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  if (stack1 = helpers.sessionsNumber) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "/dashboard\"><i class=\"fa-icon-hdd\"></i><span class=\"hidden-tablet\">Dashboard</span></a>\n                </li>\n                <li id=\"eventSessions\">\n                    <a href=\"#event/";
  if (stack1 = helpers.eventId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.eventId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "/sessions\"><i class=\"fa-icon-th-list\"></i><span class=\"hidden-tablet\">Sessions</span></a>\n                </li>\n            </ul>\n        </div>\n    </div>\n    <div id=\"content\" class=\"span11\">\n        <div id=\"eventContentAttachmentPoint\" class=\"row-fluid\"></div>\n    </div>\n</div>";
  return buffer;
  });
...
function program1(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.eventName, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</h1>";
  return buffer;
  });